defmodule OfficeTalk.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule OfficeTalk.MyChannel do
        use OfficeTalk.Web, :channel
        alias OfficeTalk.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :office_talk,
                        pubsub_server: OfficeTalk.PubSub
end
